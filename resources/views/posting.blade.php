...
<body>
        ...
        <div id="content">
            <div class="row mt-5 align-items-center justify-content-center">
                <div class="jumbotron" style="max-width: 500px;">
                    ...
                    @endif
                    @if(count($postingList) === 0 and @$notFound !== 'yes')
    ...
    <script src="{{asset('/js/modal_posting.js')}}"></script>
    <script src="{{asset('/js/ajax/highlight.js')}}"></script>
    <script src="{{asset('/js/ajax/showPosting.js')}}"></script>
    <script src="{{asset('/js/ajax/showPostingOrderByCreatedTime.js')}}"></script>
    <script src="{{asset('/js/ajax/showSearchedPosting.js')}}"></script>
    <script src="{{asset('/js/ajax/downloadImage.js')}}"></script>
    <script src="{{asset('/js/ajax/deletePosting.js')}}"></script>
    <script src="{{asset('/js/ajax/deleteImage.js')}}"></script>
</body>
</html>
