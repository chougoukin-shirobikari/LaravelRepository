...
<body>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            ...
                            <a id="showThreadOrderByNumberOfPosting" class="w-100 btn btn-outline-primary rounded-pill btn-sm mx-1"
                                data-genreid={{$genre->genre_id}}
                                data-haskeyword="yes"
                                data-sort="orderByNumberOfPosting"
    ...
    <script src="{{asset('/js/modal_thread.js')}}"></script>
    <script src="{{asset('/js/ajax/highlight.js')}}"></script>
    <script src="{{asset('/js/ajax/showThread.js')}}"></script>
    <script src="{{asset('/js/ajax/showThreadOrderByCreatedTime.js')}}"></script>
    <script src="{{asset('/js/ajax/showThreadOrderByNumberOfPosting.js')}}"></script>
    <script src="{{asset('/js/ajax/showSearchedThread.js')}}"></script>
    <script src="{{asset('/js/ajax/showUnwritableThread.js')}}"></script>
    <script src="{{asset('/js/ajax/deleteThread.js')}}"></script>
</body>
</html>
